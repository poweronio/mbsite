...
$grve_vce_add_pagination_speed = array(
	"type" => "textfield",
	"heading" => __( "Pagination Speed", "grve-osmosis-vc-extension" ),
	"param_name" => "pagination_speed",
	"value" => '400',
	"description" => __( "Pagination Speed in ms.", "grve-osmosis-vc-extension" ),
);
