 ...
 */
function grve_osmosis_vce_read_more() {
...
function grve_osmosis_vce_excerpt( $limit, $more = "" ) {
	...
	if ( has_excerpt( $post_id ) ) {
		...
		if ( 'yes' == $more ) {
			$excerpt .= grve_osmosis_vce_read_more();
		}
	} else {
...
?>
		<div class="grve-post-author" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
			<span><?php echo $author_by_string . ' '; ?></span><span itemprop="name"><?php the_author_posts_link(); ?></span>
		</div>
<?php
