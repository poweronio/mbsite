 ...
 * @since 1.1.0
 */
do_action('geodir_add_list_before_main_content');
 ...
 * @since 1.1.0
 */
do_action('geodir_add_list_page_title');
/**
 * Called before the add listing page form. This adds the mandatory messages.
 *
 * @since 1.1.0
 */
do_action('geodir_add_list_page_mandatory');
/**
 * Adds the add listing form.
 *
 * @since 1.1.0
 */
do_action('geodir_add_list_form');
 ...
 * @since 1.1.0
 */
do_action('geodir_add_list_sidebar');
