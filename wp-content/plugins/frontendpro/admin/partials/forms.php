			...
			<div id="wpfepp-form-creator" class="form-wrap">
				...
				<form class="wpfepp-ajax-form">
					...
					<div class="form-field form-required">
						...
						<?php else: ?>
							<input type="text" name="post_type" />
						<?php endif; ?>
					...
					<div class="form-field">
						...
						<p><?php _e('If you want to duplicate the fields, settings and emails of an existing form, specify it here. Otherwise defaults values will be used for everything.', 'wpfepp-plugin'); ?></p>
					</div>
