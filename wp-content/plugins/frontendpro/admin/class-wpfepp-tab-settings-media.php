...
class WPFEPP_Tab_Settings_Media extends WPFEPP_Tab
{
	...
	public function create_options(){
		...
		add_settings_section( $section, __('Media Settings', 'wpfepp-plugin'), array($this, 'section_callback'), $tab );
	    ...
	    add_settings_field(
	        ...
	        array_merge(
				array(
					'desc' 	=> __('By default WordPress does not allow contributors and subscribers to upload media items. Check this if you want to give upload capabilities to these roles.', 'wpfepp-plugin'),
