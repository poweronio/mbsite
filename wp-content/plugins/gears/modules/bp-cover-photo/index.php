...
if (!isset($bp)) return;
    ...
    if (bp_is_group_single()) {
        ...
        if ( current_user_can('manage_options') ||  $group_creator_id == $current_user)
        {
            ...
            $groups_url = trailingslashit(get_bloginfo('url') . '/' . $groups_slug . '/' . $bp->groups->current_group->slug . '/');
    ...
    /**
     * Returns the current slug of the groups
    ...
    function bcp_get_groups_slug()
    {
        ...
        if (!empty($bp_pages)) {
            ...
            $bp_groups_page_slug = $bp_groups_page->post_name; 
        } 
        ...
        if ( isset( $_POST['avatar-crop-submit'] ) ) {
           ...
           if ( ! bcp_core_avatar_handle_crop( $args ) ) {
                ...
                if (bp_is_group_single()){
                    ...
                    $current_displayed_group_url = trailingslashit(get_bloginfo('url') . '/' . $groups_slug 
