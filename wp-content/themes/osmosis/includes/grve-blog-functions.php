...
?>
	<div class="grve-post-author" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
		<span><?php echo __( 'By:', GRVE_THEME_TRANSLATE ) . ' '; ?></span><span itemprop="name"><?php the_author_posts_link(); ?></span>
	</div>
<?php
	}
}
...
?>
	<time class="grve-post-date" itemprop="datePublished" datetime="<?php the_time('c'); ?>">
...
?>
	<div id="<?php echo $element_id; ?>" class="<?php echo esc_attr( $element_class ); ?>">
		<ul class="grve-meta-elements">
			<li class="grve-field-date"><span class="grve-icon-date"></span><time itemprop="datePublished" datetime="<?php the_time('c'); ?>"><?php echo get_the_date(); ?></time></li>
			<?php if ( grve_visibility( 'post_author_visibility' ) ) { ?>
			<li><a href="#grve-about-author" itemprop="author" itemscope="" itemtype="http://schema.org/Person"><span class="grve-icon-user"></span><i itemprop="name"><?php the_author(); ?></i></a></li>
			<?php } ?>
