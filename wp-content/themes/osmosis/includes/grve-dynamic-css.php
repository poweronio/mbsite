...
#grve-main-menu-responsive.grve-style-2 .grve-more-btn:after {
	background-color: " . grve_option( 'submenu_text_color' ) . ";
}


#grve-main-menu-responsive.grve-style-2 .grve-more-btn.close:before,
#grve-main-menu-responsive.grve-style-2 .grve-more-btn.close:after {
	background-color: " . grve_option( 'submenu_text_hover_color' ) . ";
}
...
#grve-page-title.grve-blog-title {
	background-color: " . grve_option( 'blog_title_background_color' ) . ";
}
...
#grve-product-title.grve-product-tax-title {
	background-color: " . grve_option( 'product_tax_title_background_color' ) . ";
}
...
#grve-product-title {
	background-color: " . grve_option( 'product_title_background_color' ) . ";
}
...
/* Footer Bar */
$grve_footer_bar_bg_color = grve_option( 'footer_bar_bg_color', '#ffffff' );
$css .= "

#grve-footer-bar {
	background-color: rgba(" . grve_hex2rgb( $grve_footer_bar_bg_color ) . "," . grve_option( 'footer_bar_bg_color_opacity', '1') . ");
...
.grve-iso-spinner svg path {
	fill: " . grve_option( 'body_text_color' ) . ";
}
";
