...
function grve_backend_scripts( $hook ) {
	...
	wp_register_style( 'grve-page-feature-section', get_template_directory_uri() . '/includes/css/grve-page-feature-section.css', array(), '1.0.2' );
	...
	wp_register_script( 'grve-custom-sidebars', get_template_directory_uri() . '/includes/js/grve-custom-sidebars.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-custom-sidebars', 'grve_custom_sidebar_texts', $grve_custom_sidebar_texts );

	wp_register_script( 'grve-upload-slider-script', get_template_directory_uri() . '/includes/js/grve-upload-slider.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-upload-slider-script', 'grve_upload_slider_texts', $grve_upload_slider_texts );

	wp_register_script( 'grve-upload-feature-slider-script', get_template_directory_uri() . '/includes/js/grve-upload-feature-slider.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-upload-feature-slider-script', 'grve_upload_feature_slider_texts', $grve_upload_slider_texts );

	wp_register_script( 'grve-upload-image-replace-script', get_template_directory_uri() . '/includes/js/grve-upload-image-replace.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-upload-image-replace-script', 'grve_upload_image_replace_texts', $grve_upload_image_replace_texts );

	wp_register_script( 'grve-upload-simple-media-script', get_template_directory_uri() . '/includes/js/grve-upload-simple.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-upload-simple-media-script', 'grve_upload_media_texts', $grve_upload_media_texts );

	wp_register_script( 'grve-upload-image-script', get_template_directory_uri() . '/includes/js/grve-upload-image.js', array( 'jquery'), false, '2.0.0' );
	wp_localize_script( 'grve-upload-image-script', 'grve_upload_image_texts', $grve_upload_image_texts );

	wp_register_script( 'grve-page-feature-section-script', get_template_directory_uri() . '/includes/js/grve-page-feature-section.js', array( 'jquery', 'wp-color-picker' ), false, '2.0.0' );
	wp_localize_script( 'grve-page-feature-section-script', 'grve_feature_section_texts', $grve_feature_section_texts );

	wp_register_script( 'grve-post-options-script', get_template_directory_uri() . '/includes/js/grve-post-options.js', array( 'jquery'), false, '2.0.0' );
	wp_register_script( 'grve-portfolio-options-script', get_template_directory_uri() . '/includes/js/grve-portfolio-options.js', array( 'jquery'), false, '2.0.0' );

	wp_register_script( 'grve-modal-script' , get_template_directory_uri() . '/includes/js/grve-modal.js' , array( 'jquery', 'backbone', 'underscore'), false, '2.0.0' );
	...
	if ( $hook == 'post-new.php' || $hook == 'post.php' ) {
        ...
        if ( 'post' === $post->post_type ) {
			...
			if ( 'portfolio' === $post->post_type) {
				wp_enqueue_script( 'grve-portfolio-options-script' );
			}
...
function grve_admin_login_logo() {
	...
	if ( $replace_logo ) {
		...
		$grve_logo_height = grve_option( 'logo', '84', 'height' );
		if ( $grve_logo_height > 84 ) {
			$grve_logo_height = 84;
		}
		$grve_logo_width = grve_option( 'logo', '300', 'width' );
		...
		if ( !empty( $grve_logo ) ) {
			...
			<style>
			.login h1 a {
				background-image: url('" . $grve_logo . "');
				width: 100%;
				height: " . $grve_logo_height . "px;
				background-size: " . $grve_logo_width . "px auto;
			}
			</style>
			";
		}
