...
*/
	...
	function grve_portfolio_options_add_custom_boxes() {
		...
		add_meta_box(
			'portfolio_link_mode',
			__( 'Portfolio Link Options', GRVE_THEME_TRANSLATE ),
			'grve_portfolio_link_mode_box',
			'portfolio'
		);
		add_meta_box(
	...
	function grve_portfolio_link_mode_box( $post ) {
	...
	?>
		<table class="form-table grve-metabox">
			<tbody>
				<tr>
					<td colspan="2">
						<p class="howto"><?php _e( 'Select link mode for Portfolio Overview (Used in Portfolio Element Link Type: Custom Link).', GRVE_THEME_TRANSLATE ); ?></p>
					</td>
				</tr>
				<tr class="grve-border-bottom">
					<th>
						<label for="grve-portfolio-link-mode">
							<strong><?php _e( 'Link Mode', GRVE_THEME_TRANSLATE ); ?></strong>
							<span>
								<?php _e( 'Select Link Mode', GRVE_THEME_TRANSLATE ); ?>
							</span>
						</label>
					</th>
					<td>
						<select id="grve-portfolio-link-mode" name="grve_portfolio_link_mode">
							<option value="" <?php selected( '', $link_mode ); ?>><?php _e( 'Portfolio Item', GRVE_THEME_TRANSLATE ); ?></option>
							<option value="link" <?php selected( 'link', $link_mode ); ?>><?php _e( 'Custom Link', GRVE_THEME_TRANSLATE ); ?></option>
							<option value="none" <?php selected( 'none', $link_mode ); ?>><?php _e( 'None', GRVE_THEME_TRANSLATE ); ?></option>
						</select>
					</td>
				</tr>
				...
				<tr class="grve-portfolio-custom-link-mode" <?php if ( "link" != $link_mode ) { ?> style="display:none;" <?php } ?>>
					<th>
						<label for="grve-portfolio-link-extra-class">
							<strong><?php _e( 'Link extra class name', GRVE_THEME_TRANSLATE ); ?></strong>
						</label>
					</th>
					<td>
				...
				<tr>
					<th>
						<label for="grve-go-to-section">
							<strong><?php _e( 'Go To Section', GRVE_THEME_TRANSLATE ); ?></strong>
							<span>
								<?php _e( 'If selected, all sections with Section ID will be enhanced with navigation.', GRVE_THEME_TRANSLATE ); ?>
							</span>
						</label>
					</th>
					<td>
				...
				<tr>
					<th>
						<label for="grve-disable-sticky-header">
							<strong><?php _e( 'Disable Sticky Header', GRVE_THEME_TRANSLATE ); ?></strong>
							<span>
								<?php _e( 'If selected, sticky header will be disabled.', GRVE_THEME_TRANSLATE ); ?>
							</span>
						</label>
					</th>
					<td>
					...
					<tr class="grve-portfolio-media-item grve-portfolio-media-image-mode"<?php if ( "slider" != $portfolio_media || "gallery-vertical" != $portfolio_media ) { ?> style="display:none;" <?php } ?>>
						...
						<td>
							<select id="grve-portfolio-media-image-mode" name="grve_portfolio_media_image_mode">
								<option value="" <?php selected( '', $portfolio_image_mode ); ?>><?php _e( 'Auto Crop', GRVE_THEME_TRANSLATE ); ?></option>
								<option value="resize" <?php selected( 'resize', $portfolio_image_mode ); ?>><?php _e( 'Resize', GRVE_THEME_TRANSLATE ); ?></option>
							</select>
						</td>
					</tr>
