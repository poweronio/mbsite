...
?>
	<li>
		<div class="<?php echo $setting_class; ?>">
	...
	<div class="grve-map-item postbox">
		...
		<div class="inside">
			...
			<ul class="grve-map-setting">
				...
				<li>
					<div class="grve-setting">
						<label><?php _e( 'Longitude', GRVE_THEME_TRANSLATE ); ?></label>
				...
				<?php
					if( 'simple' == $grve_settings_mode ) {
						grve_print_admin_feature_setting( 'label', __( 'Title / Info Text', GRVE_THEME_TRANSLATE ) );
						grve_print_admin_feature_setting( 'textfield', __( 'Title', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_title[]', $map_title );
						grve_print_admin_feature_setting( 'textfield', __( 'Info Text', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_infotext[]', $map_infotext );
						grve_print_admin_feature_setting( 'label', __( 'Button', GRVE_THEME_TRANSLATE ) );
						grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_button_text[]', $button_text );
						grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_button_url[]', $button_url );
						grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_button_target[]', $button_target );
						grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_button_color[]', $button_color );
						grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_map_item_point_button_class[]', $button_class );
					}
				?>
			</ul>
			<?php if( 'modal' == $grve_settings_mode ) { ?>
			<div class="grve-map-data-container">
				...
				<input type="hidden" id="grve_map_item_point_button_class<?php echo $map_item_id ; ?>" value="<?php echo esc_attr( $button_class ); ?>" name="grve_map_item_point_button_class[]" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
				</div>
			<?php } ?>
		</div>
	</div>
...
?>
	...
	<div class="grve-image-item postbox">
		...
		<div class="inside">
			...
			<?php
				grve_print_admin_feature_setting( 'label', __( 'Title / Caption', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Title', GRVE_THEME_TRANSLATE ), 'grve_image_item_title', $title );
				grve_print_admin_feature_setting( 'textfield', __( 'Caption', GRVE_THEME_TRANSLATE ), 'grve_image_item_caption', $caption );
				grve_print_admin_feature_setting( 'select-color', __( 'Title Color', GRVE_THEME_TRANSLATE ), 'grve_image_item_title_color', $title_color );
				grve_print_admin_feature_setting( 'select-color', __( 'Caption Color', GRVE_THEME_TRANSLATE ), 'grve_image_item_caption_color', $caption_color );
				grve_print_admin_feature_setting( 'select-style', __( 'Title / Caption Style', GRVE_THEME_TRANSLATE ), 'grve_image_item_style', $style );
				grve_print_admin_feature_setting( 'select-align', __( 'Alignment', GRVE_THEME_TRANSLATE ), 'grve_image_item_text_align', $text_align );
				grve_print_admin_feature_setting( 'select-text-animation', __( 'Animation', GRVE_THEME_TRANSLATE ), 'grve_image_item_text_animation', $text_animation );

				grve_print_admin_feature_setting( 'label', __( 'Background', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'select-bg-position', __( 'Background Position', GRVE_THEME_TRANSLATE ), 'grve_image_item_bg_position', $bg_position );
				grve_print_admin_feature_setting( 'select-bg-effect', __( 'Background Effect', GRVE_THEME_TRANSLATE ), 'grve_image_item_bg_effect', $bg_effect );

				grve_print_admin_feature_setting( 'label', __( 'Overlay', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'select-pattern-overlay', __( 'Pattern Overlay', GRVE_THEME_TRANSLATE ), 'grve_image_item_pattern_overlay', $pattern_overlay );
				grve_print_admin_feature_setting( 'select-color-overlay', __( 'Color Overlay', GRVE_THEME_TRANSLATE ), 'grve_image_item_color_overlay', $color_overlay );
				grve_print_admin_feature_setting( 'select-opacity-overlay', __( 'Opacity Overlay', GRVE_THEME_TRANSLATE ), 'grve_image_item_opacity_overlay', $opacity_overlay );

				grve_print_admin_feature_setting( 'label', __( 'First Button', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_text', $button_text );
				grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_url', $button_url );
				grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_target', $button_target );
				grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_color', $button_color );
				grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_size', $button_size );
				grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_shape', $button_shape );
				grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_type', $button_type );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_image_item_button_class', $button_class );

				grve_print_admin_feature_setting( 'label', __( 'Second Button', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_text', $button_text2 );
				grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_url', $button_url2 );
				grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_target', $button_target2 );
				grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_color', $button_color2 );
				grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_size', $button_size2 );
				grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_shape', $button_shape2 );
				grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_type', $button_type2 );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_image_item_button2_class', $button_class );

				grve_print_admin_feature_setting( 'label', __( 'Extras', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Extra Class', GRVE_THEME_TRANSLATE ), 'grve_image_item_el_class', $el_class );
			?>
				</ul>
			<?php
				} else {
			?>
				<div class="grve-image-data-container">
					...
					<input type="hidden" id="grve_image_item_button_class<?php echo $image_item_id ; ?>" value="<?php echo esc_attr( $button_class ); ?>" name="grve_image_item_button_class" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
					...
					<input type="hidden" id="grve_image_item_button2_class<?php echo $image_item_id ; ?>" value="<?php echo esc_attr( $button_class2 ); ?>" name="grve_image_item_button2_class" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
...
?>
	...
	<div class="grve-slider-item postbox <?php echo $grve_closed_class; ?>">
		...
		<div class="inside">
			...
			<?php
				grve_print_admin_feature_setting( 'label', __( 'Title / Caption', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Title', GRVE_THEME_TRANSLATE ), 'grve_slider_item_title[]', $title );
				grve_print_admin_feature_setting( 'textfield', __( 'Caption', GRVE_THEME_TRANSLATE ), 'grve_slider_item_caption[]', $caption );
				grve_print_admin_feature_setting( 'select-color', __( 'Title Color', GRVE_THEME_TRANSLATE ), 'grve_slider_item_title_color[]', $title_color );
				grve_print_admin_feature_setting( 'select-color', __( 'Caption Color', GRVE_THEME_TRANSLATE ), 'grve_slider_item_caption_color[]', $caption_color );
				grve_print_admin_feature_setting( 'select-style', __( 'Title / Caption Style', GRVE_THEME_TRANSLATE ), 'grve_slider_item_style[]', $style );
				grve_print_admin_feature_setting( 'select-align', __( 'Alignment', GRVE_THEME_TRANSLATE ), 'grve_slider_item_text_align[]', $text_align );
				grve_print_admin_feature_setting( 'select-text-animation', __( 'Animation', GRVE_THEME_TRANSLATE ), 'grve_slider_item_text_animation[]', $text_animation );

				grve_print_admin_feature_setting( 'label', __( 'Header / Background Position', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'select-bg-position', __( 'Background Position', GRVE_THEME_TRANSLATE ), 'grve_slider_item_bg_position[]', $bg_position );
				grve_print_admin_feature_setting( 'select-header-style', __( 'Header Style', GRVE_THEME_TRANSLATE ), 'grve_slider_item_header_style[]', $header_style );

				grve_print_admin_feature_setting( 'label', __( 'Overlay', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'select-pattern-overlay', __( 'Pattern Overlay', GRVE_THEME_TRANSLATE ), 'grve_slider_item_pattern_overlay[]', $pattern_overlay );
				grve_print_admin_feature_setting( 'select-color-overlay', __( 'Color Overlay', GRVE_THEME_TRANSLATE ), 'grve_slider_item_color_overlay[]', $color_overlay );
				grve_print_admin_feature_setting( 'select-opacity-overlay', __( 'Opacity Overlay', GRVE_THEME_TRANSLATE ), 'grve_slider_item_opacity_overlay[]', $opacity_overlay );

				grve_print_admin_feature_setting( 'label', __( 'First Button', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_text[]', $button_text );
				grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_url[]', $button_url );
				grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_target[]', $button_target );
				grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_color[]', $button_color );
				grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_size[]', $button_size );
				grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_shape[]', $button_shape );
				grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_type[]', $button_type );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button_class[]', $button_class );

				grve_print_admin_feature_setting( 'label', __( 'Second Button', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_text[]', $button_text2 );
				grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_url[]', $button_url2 );
				grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_target[]', $button_target2 );
				grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_color[]', $button_color2 );
				grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_size[]', $button_size2 );
				grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_shape[]', $button_shape2 );
				grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_type[]', $button_type2 );
				grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_slider_item_button2_class[]', $button_class2 );

				grve_print_admin_feature_setting( 'label', __( 'Extras', GRVE_THEME_TRANSLATE ) );
				grve_print_admin_feature_setting( 'textfield', __( 'Extra Class', GRVE_THEME_TRANSLATE ), 'grve_slider_item_el_class[]', $el_class );
			?>
				</ul>
			<?php
				} else {
			?>
				<div class="grve-slider-data-container">
					...
					<input type="hidden" id="grve_slider_item_button_class<?php echo $slider_item_id ; ?>" value="<?php echo esc_attr( $button_class ); ?>" name="grve_slider_item_button_class[]" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
					...
					<input type="hidden" id="grve_slider_item_button2_class<?php echo $slider_item_id ; ?>" value="<?php echo esc_attr( $button_class2 ); ?>" name="grve_slider_item_button2_class[]" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
...
<?php
		grve_print_admin_feature_setting( 'label', __( 'Title / Caption', GRVE_THEME_TRANSLATE ) );
		grve_print_admin_feature_setting( 'textfield', __( 'Title', GRVE_THEME_TRANSLATE ), 'grve_video_item_title', $title );
		grve_print_admin_feature_setting( 'textfield', __( 'Caption', GRVE_THEME_TRANSLATE ), 'grve_video_item_caption', $caption );
		grve_print_admin_feature_setting( 'select-color', __( 'Title Color', GRVE_THEME_TRANSLATE ), 'grve_video_item_title_color', $title_color );
		grve_print_admin_feature_setting( 'select-color', __( 'Caption Color', GRVE_THEME_TRANSLATE ), 'grve_video_item_caption_color', $caption_color );
		grve_print_admin_feature_setting( 'select-style', __( 'Title / Caption Style', GRVE_THEME_TRANSLATE ), 'grve_video_item_style', $style );
		grve_print_admin_feature_setting( 'select-align', __( 'Alignment', GRVE_THEME_TRANSLATE ), 'grve_video_item_text_align', $text_align );
		grve_print_admin_feature_setting( 'select-text-animation', __( 'Animation', GRVE_THEME_TRANSLATE ), 'grve_video_item_text_animation', $text_animation );

		grve_print_admin_feature_setting( 'label', __( 'Overlay', GRVE_THEME_TRANSLATE ) );
		grve_print_admin_feature_setting( 'select-pattern-overlay', __( 'Pattern Overlay', GRVE_THEME_TRANSLATE ), 'grve_video_item_pattern_overlay', $pattern_overlay );
		grve_print_admin_feature_setting( 'select-color-overlay', __( 'Color Overlay', GRVE_THEME_TRANSLATE ), 'grve_video_item_color_overlay', $color_overlay );
		grve_print_admin_feature_setting( 'select-opacity-overlay', __( 'Opacity Overlay', GRVE_THEME_TRANSLATE ), 'grve_video_item_opacity_overlay', $opacity_overlay );

		grve_print_admin_feature_setting( 'label', __( 'First Button', GRVE_THEME_TRANSLATE ) );
		grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_text', $button_text );
		grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_url', $button_url );
		grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_target', $button_target );
		grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_color', $button_color );
		grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_size', $button_size );
		grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_shape', $button_shape );
		grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_type', $button_type );
		grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_video_item_button_class', $button_class );

		grve_print_admin_feature_setting( 'label', __( 'Second Button', GRVE_THEME_TRANSLATE ) );
		grve_print_admin_feature_setting( 'textfield', __( 'Button Text', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_text', $button_text2 );
		grve_print_admin_feature_setting( 'textfield', __( 'Button URL', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_url', $button_url2 );
		grve_print_admin_feature_setting( 'select-button-target', __( 'Button Target', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_target', $button_target2 );
		grve_print_admin_feature_setting( 'select-button-color', __( 'Button Color', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_color', $button_color2 );
		grve_print_admin_feature_setting( 'select-button-size', __( 'Button Size', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_size', $button_size2 );
		grve_print_admin_feature_setting( 'select-button-shape', __( 'Button Shape', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_shape', $button_shape2 );
		grve_print_admin_feature_setting( 'select-button-type', __( 'Button Type', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_type', $button_type2 );
		grve_print_admin_feature_setting( 'textfield', __( 'Button Class', GRVE_THEME_TRANSLATE ), 'grve_video_item_button2_class', $button_class2 );

		grve_print_admin_feature_setting( 'label', __( 'Extras', GRVE_THEME_TRANSLATE ) );
		grve_print_admin_feature_setting( 'textfield', __( 'Extra Class', GRVE_THEME_TRANSLATE ), 'grve_video_item_el_class', $el_class );
...
?>
	<div class="grve-video-data-container">
		...
		<input type="hidden" id="grve_video_item_button_class<?php echo $video_item_id ; ?>" value="<?php echo esc_attr( $button_class ); ?>" name="grve_video_item_button_class" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
		...
		<input type="hidden" id="grve_video_item_button2_class<?php echo $video_item_id ; ?>" value="<?php echo esc_attr( $button_class2 ); ?>" name="grve_video_item_button2_class" data-meta-template="#grve-textfield-template" data-meta-title="<?php _e( 'Button Class', GRVE_THEME_TRANSLATE ); ?>" data-meta-desc="<?php _e( 'Type button class name.', GRVE_THEME_TRANSLATE ); ?>">
...
function grve_print_revolution_selection( $revslider_alias, $id, $name ) {
	...
	?>
		<select id="<?php echo $id; ?>" name="<?php echo $name; ?>" class="grve-feature-section-item">
	<?php
		global $wpdb;
	...
	?>
			<option value="" <?php selected( '', $revslider_alias ); ?>>
				<?php echo __( 'None', GRVE_THEME_TRANSLATE ); ?>
			</option>
	<?php
			foreach ( $rs as $revslider ) {
	?>
			<option value="<?php echo $revslider->alias; ?>" <?php selected( $revslider->alias, $revslider_alias ); ?>>
				<?php echo $revslider->title; ?>
			</option>
	<?php
			}
		} else {
	?>
			<option value="" <?php selected( '', $revslider_alias ); ?>>
				<?php echo __( 'No sliders found', GRVE_THEME_TRANSLATE ); ?>
			</option>
	<?php
		}
	?>
	...
	?>
		<?php echo __( 'Revolution Slider is not activated!', GRVE_THEME_TRANSLATE ); ?>
				...
				<tr class="grve-border-bottom">
					...
					<td>
						<select id="grve-page-feature-element" name="grve_page_feature_element">
							...
							<option value="revslider" <?php if ( "revslider" == $feature_element ) { ?> selected="selected" <?php } ?>><?php _e( 'Revolution Slider', GRVE_THEME_TRANSLATE ); ?></option>
				...
				<tr id="grve-feature-section-size" class="grve-feature-section-item" <?php if ( "" == $feature_element ) { ?> style="display:none;" <?php } ?>>
					...
					<td>
						...
						<span id="grve-feature-section-height-rev" class="grve-inner-field" style="display:none;">
							<label><?php _e( 'Height is configured from Revolution Slider Settings', GRVE_THEME_TRANSLATE ); ?></label>
						</span>
					</td>
				</tr>
			...
			<div class="grve-video-item postbox">
				...
				<div class="inside">
					<ul class="grve-video-setting">
						...
						<li>
							<div class="grve-setting">
								<label><?php _e( 'Loop', GRVE_THEME_TRANSLATE ); ?></label>
								<select name="grve_video_item_loop">
									<option value="yes" <?php selected( 'yes', $video_loop ); ?>><?php _e( 'Yes', GRVE_THEME_TRANSLATE ); ?></option>
									<option value="no" <?php selected( 'no', $video_loop ); ?>><?php _e( 'No', GRVE_THEME_TRANSLATE ); ?></option>
								</select>
							</div>
						</li>
						<li>
							<div class="grve-setting">
								<label><?php _e( 'Muted', GRVE_THEME_TRANSLATE ); ?></label>
								<select name="grve_video_item_muted">
									<option value="yes" <?php selected( 'yes', $video_muted ); ?>><?php _e( 'Yes', GRVE_THEME_TRANSLATE ); ?></option>
									<option value="no" <?php selected( 'no', $video_muted ); ?>><?php _e( 'No', GRVE_THEME_TRANSLATE ); ?></option>
								</select>
							</div>
						</li>
					</ul>
...
function grve_admin_save_feature_section( $post_id ) {
	...
	if ( isset( $_POST['grve_slider_item_id'] ) ) {
		...
		for ( $i=0; $i < $num_of_images; $i++ ) {
			...
			$this_image = array (
				...
				'button_class' => $_POST['grve_slider_item_button_class'][ $i ],
				...
				'button_class2' => $_POST['grve_slider_item_button2_class'][ $i ],
			);
	...
	if ( isset( $_POST['grve_image_item_id'] ) ) {
		...
		$image_item = array (
			...
			'button_class' => $_POST['grve_image_item_button_class'],
			...
			'button_class2' => $_POST['grve_image_item_button2_class'],
		);
	...
	if ( isset( $_POST['grve_video_item_title'] ) ) {
		...
		$video_item = array (
			...
			'video_loop' => $_POST['grve_video_item_loop'],
			'video_muted' => $_POST['grve_video_item_muted'],
			...
			'button_class' => $_POST['grve_video_item_button_class'],
			...
			'button_class2' => $_POST['grve_video_item_button2_class'],
		);
