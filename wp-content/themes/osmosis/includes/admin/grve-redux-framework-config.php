	...
	class GRVE_Redux_Framework_config {
		...
		public function setSections() {
			...
			$grve_safe_button_options = array(
				...
				'language' => __( 'Language selector (WPML or Polylang Required)', GRVE_THEME_TRANSLATE ),
			...
			$grve_header_menu_selection = array(
				...
				'ubermenu' => __( 'UberMenu Direct', GRVE_THEME_TRANSLATE ),
				'disabled' => __( 'Disabled', GRVE_THEME_TRANSLATE ),
			);

			$grve_retina_support_selection = array(
				'default' => __( 'Theme Defined Images Only', GRVE_THEME_TRANSLATE ),
				'full' => __( 'Full', GRVE_THEME_TRANSLATE ),
				'disabled' => __( 'Disabled', GRVE_THEME_TRANSLATE ),
			);
			...
			$grve_menu_pointers = array(
				'none' => __( 'None', GRVE_THEME_TRANSLATE ),
				'arrow' => __( 'Arrow', GRVE_THEME_TRANSLATE ),
			);
			...
			$grve_settings_mode_selection = array(
				'modal' => __( 'Modal', GRVE_THEME_TRANSLATE ),
				'simple' => __( 'Simple', GRVE_THEME_TRANSLATE ),
			);
			...
			$grve_menu_responsibe_toggle_selection = array(
				'icon' => __( 'Icon', GRVE_THEME_TRANSLATE ),
				'text' => __( 'Text', GRVE_THEME_TRANSLATE ),
			);
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Content Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the content.', GRVE_THEME_TRANSLATE ),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						...
						'subtitle' => __( 'Enter Header height in px (Default is 90).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
					...
					array(
						'id' => 'submenu_pointer',
						'type' => 'select',
						'title' => __( 'Sub Menu Pointer', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Choose pointer for the submenu.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Responsive Menu options for the Default Header', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'menu_responsive_style',
						'type' => 'select',
						'title' => __( 'Responsive Menu Style', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the style for your responsive menu.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Responsive Menu Toggle Button Selection', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the toggle button content for your responsive menu.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type' => 'text',
						'title' => __( 'Responsive Menu Text', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter the text for your responsive menu.', GRVE_THEME_TRANSLATE ),
						'default' => 'Menu',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'sticky_footer',
						'type' => 'checkbox',
						'title' => __( 'Sticky Footer', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want a sticky footer.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
					array(
						'id'       => 'footer_background',
						'type'     => 'background',
						'title'    => __( 'Footer Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the footer.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Footer Social Display', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select how you want to display your social items.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'text' => __( 'Text', GRVE_THEME_TRANSLATE ),
							'icon' => __( 'Icons', GRVE_THEME_TRANSLATE ),
						),
						'default' => 'text',
						'validate' => 'not_empty',
						'required' => array(
			...
			$this->sections[] = array(
				...
				'desc' => __( 'Changes here will affect the settings for the assigned blog page in case you have set a Static Page as blog page in Settings > Reading > Front Page Displays. Also these settings also affect Archives / Categories / Tags overview pages.', GRVE_THEME_TRANSLATE ),
				'submenu' => true,
				'customizer' => false,
				'fields' => array(
					array(
					...
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Blog Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter blog title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
						'id' => 'blog_title_alignment',
						'type' => 'select',
						'title' => __( 'Blog Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the blog title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Blog Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the blog title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
					...
					array(
						...
						'type' => 'switch',
						'title' => __( 'Author Field Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Easily disable the author field of your blog.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'switch',
						'title' => __( 'Featured Image Visibility (Standard Post)', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Toggle Featured Image on or off.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'switch',
						'title' => __( 'Post Tags Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Enable / Disable the post tags.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'switch',
						'title' => __( 'Post Categories Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Enable / Disable the post categories.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					...
					array(
						...
						'type' => 'switch',
						'title' => __( 'Posts Navigation Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Enable / Disable the visibility of the posts navigation.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'checkbox',
						'title' => __( 'Post Navigation Same Term', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'If selected, only navigation items from the current taxonomy term will be displayed.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					...
					array(
						...
						'subtitle'=> __( 'Set the style for the default single post title ( Not applicable for Simple Style ).', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'subtitle' => __( 'Enter the Post title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
						'id'       => 'post_title_background',
						'type'     => 'background',
						'title'    => __( 'Single Post Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the single post title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => __( 'Enter Page title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
					...
					array(
						...
						'type'     => 'background',
						'title' => __( 'Page Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the default page title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
					...
					array(
						...
						'type' => 'checkbox',
						'title' => __( 'Highlight current anchor menu', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want to highlight current anchor menu.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
					array(
						'id' => 'page_anchor_menu_incontainer',
						'type' => 'checkbox',
						'title' => __( 'In Container', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want to show your anchor menu inside the container instead of full width.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
					array(
						'id' => 'page_anchor_menu_center',
						'type' => 'checkbox',
						'title' => __( 'Center', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want to show your anchor menu centered.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
				)
			);
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'select',
						'compiler' => true,
						'title' => __( 'Portfolio Style', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the style for the single portfolio.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'default' => __( 'Osmosis', GRVE_THEME_TRANSLATE ),
							'simple' => __( 'Simple', GRVE_THEME_TRANSLATE ),
						),
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Portfolio Backlink', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the overview page for your portfolio backlink.', GRVE_THEME_TRANSLATE ),
						'data' => 'page',
						'default' => '',
					),
					array(
						...
						'type' => 'checkbox',
						'title' => __( 'Portfolio Navigation Same Term', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'If selected, only navigation items from the current taxonomy term will be displayed.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
					array(
					...
					array(
						...
						'type' => 'text',
						'title' => __( 'Portfolio Details Text', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Type text for the Portfolio Details title.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'subtitle' => __( 'Enter Portfolio title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Portfolio Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the portfolio title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
			...
			$this->sections[] = array(
				...
				'icon_class' => 'el-icon-large',
				'title' => __( 'WooCommerce Options', GRVE_THEME_TRANSLATE),
				'subtitle' => __( 'You can find the Theme settings for the WooCommerce here.', GRVE_THEME_TRANSLATE ),
				'submenu' => true,
				'customizer' => false,
				'fields' => array(
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Product Taxonomy Title Settings', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Set the style for the product taxonomy title.', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id'=>'product_tax_title_visibility',
						'type' => 'switch',
						'title' => __( 'Taxonomy Title Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Easily disable the title of your product taxonomy.', GRVE_THEME_TRANSLATE ),
						"default" => '1',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Product Taxonomy Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter product taxonomy title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Product Taxonomy Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the default product taxonomy title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Product Taxonomy Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the product taxonomy title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Product Title Settings', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Set the style for the product title.', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id'=>'product_title_visibility',
						'type' => 'switch',
						'title' => __( 'Product Title Visibility', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Easily disable the top title of your product.', GRVE_THEME_TRANSLATE ),
						"default" => '0',
						'on' => __( 'On', GRVE_THEME_TRANSLATE ),
						'off' => __( 'Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Product Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter product title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Product Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the default product title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Product Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the product title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
			...
			$this->sections[] = array(
				...
				'icon_class' => 'el-icon-large',
				'title' => __( 'Event Calendar Options', GRVE_THEME_TRANSLATE),
				'subtitle' => __( 'You can find the Theme settings for the Event Calendar here.', GRVE_THEME_TRANSLATE ),
				'submenu' => true,
				'customizer' => false,
				'fields' => array(
					array(
						...
						'type' => 'image_select',
						'compiler' => true,
						'title' => __( 'Event Taxonomy Layout', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the layout for the event taxonomies. Choose among Full Width, Left Sidebar or Right Sidebar.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_layout_selection,
						'default' => 'none',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Event Taxonomy Sidebar', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the sidebar for the event taxonomies.', GRVE_THEME_TRANSLATE ),
						'data' => 'sidebar',
						'default' => 'grve-default-sidebar',
						'validate' => 'not_empty',
					),
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Event Taxonomy Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter event taxonomy title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
						'id' => 'event_tax_title_alignment',
						'type' => 'select',
						'title' => __( 'Event Taxonomy Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the default event taxonomy title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Event Taxonomy Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the event taxonomy title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Single Event', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Define your preference for the single event.', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'event_layout',
						'type' => 'image_select',
						'compiler' => true,
						'title' => __( 'Event Layout', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the layout for the single event. Choose among Full Width, Left Sidebar or Right Sidebar.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_layout_selection,
						'default' => 'none',
					),
					array(
						'id' => 'event_sidebar',
						'type' => 'select',
						'title' => __( 'Event Sidebar', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the sidebar for the single event.', GRVE_THEME_TRANSLATE ),
						'data' => 'sidebar',
						'default' => 'grve-default-sidebar',
						'validate' => 'not_empty',
					),
					array(
						...
						'type' => 'select',
						'compiler' => true,
						'title' => __( 'Event Style', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the style for the single event.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'default' => __( 'Osmosis', GRVE_THEME_TRANSLATE ),
							'simple' => __( 'Simple', GRVE_THEME_TRANSLATE ),
						),
					...
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Event Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter event title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
						'id' => 'event_title_alignment',
						'type' => 'select',
						'title' => __( 'Event Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the default event title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Event Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the event title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
			...
			$this->sections[] = array(
				...
				'icon_class' => 'el-icon-large',
				'title' => __( 'bbPress Forum Options', GRVE_THEME_TRANSLATE),
				'subtitle' => __( 'You can find the Theme settings for the bbPress forum here.', GRVE_THEME_TRANSLATE ),
				'submenu' => true,
				'customizer' => false,
				'fields' => array(
					array(
						...
						'type' => 'image_select',
						'compiler' => true,
						'title' => __( 'Forum Layout', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the layout for the forum. Choose among Full Width, Left Sidebar or Right Sidebar.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_layout_selection,
						'default' => 'none',
					),
					array(
						'id' => 'forum_sidebar',
						'type' => 'select',
						'title' => __( 'Forum Sidebar', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the sidebar for the forum.', GRVE_THEME_TRANSLATE ),
						'data' => 'sidebar',
						'default' => 'grve-default-sidebar',
						'validate' => 'not_empty',
					),
					array(
						...
						'type' => 'text',
						'default' => '350',
						'title' => __( 'Forum Title Height', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Enter forum title height in px (Default is 350).', GRVE_THEME_TRANSLATE ),
						'validate' => 'numeric',
					),
					array(
						'id' => 'forum_title_alignment',
						'type' => 'select',
						'title' => __( 'Forum Title Alignment', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select your alignment for the default forum title.', GRVE_THEME_TRANSLATE ),
						'options' => array(
							'left' => __( 'Left', GRVE_THEME_TRANSLATE ),
							'right' => __( 'Right', GRVE_THEME_TRANSLATE ),
							'center' => __( 'Center', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type'     => 'background',
						'title'    => __( 'Forum Title Background Image', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select a background image for the forum title.', GRVE_THEME_TRANSLATE ),
						'background-color' => false,
						'background-repeat' => false,
						'background-attachment' => false,
						'background-clip' => false,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Logo as text Fonts', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'logo_font',
						'type' => 'typography',
						'title' => __( 'Logo Font', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Specify the logo font properties.', GRVE_THEME_TRANSLATE ),
						'google' => true,
						'line-height'=> false,
						'text-align'=> false,
						'letter-spacing' => true,
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Page/Blog Typography', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'page_title',
						'type' => 'typography',
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => __( 'Product/Product Taxonomy Typography', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'product_title',
						'type' => 'typography',
						'title' => __( 'Product Title', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Specify the font for the default single product titles and product taxonomies.', GRVE_THEME_TRANSLATE ),
						'google' => true,
						'line-height' => false,
						'text-align' => false,
						'letter-spacing' => true,
			...
			$this->sections[] = array(
				...
				'header' => '',
				'desc' => __( 'Set the background colors for the sidebars. Notice that you can override these in pages, single posts, single portfolios and single events.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Event Taxonomy Sidebar Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the background color of the event taxonomies.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_bg_color_selection,
						'default' => 'none',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Event Sidebar Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the background color for the sidebar in single events.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_bg_color_selection,
						'default' => 'none',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Forum Sidebar Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the background color of the forum.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_bg_color_selection,
						'default' => 'none',
					),
				)
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type'        => 'select',
						'title'       => __('Background Opacity', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Select opacity for your Footer Bar Area.', GRVE_THEME_TRANSLATE ),
						'options'     => $grve_opacity_selection,
						"default"     => '1',
					),
					array(
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Blog Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the blog title area and the color of the blog title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Background color for your blog title.', GRVE_THEME_TRANSLATE ),
						'transparent' => false,
						'default'  => '#303030',
					),
					array(
						...
						'subtitle'    => __( 'Color for your blog title.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'subtitle'    => __( 'Color for your blog description.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Product Taxonomy Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the product taxonomy title area and the color of the product taxonomy title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Background color for your product taxonomy title.', GRVE_THEME_TRANSLATE ),
						'transparent' => false,
						'default'  => '#303030',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Title Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your product taxonomy title.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Product Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the single product title area and the color of the product title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Background color for your product title.', GRVE_THEME_TRANSLATE ),
						'transparent' => false,
						'default'  => '#303030',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Title Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your product title.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Event Taxonomy Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the event taxonomy title area and the color of the event taxonomy title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Background color for your event taxonomy title.', GRVE_THEME_TRANSLATE ),
						'transparent' => false,
						'default'  => '#303030',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Title Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your event taxonomy title.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Description Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your event taxonomy description.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Event Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the single event title area and the color of the event title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Background color for your event title.', GRVE_THEME_TRANSLATE ),
						'transparent' => false,
						'default'  => '#303030',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Title Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your event title.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
					array(
						...
						'type' => 'select',
						'title' => __( 'Description Color', GRVE_THEME_TRANSLATE ),
						'subtitle'    => __( 'Color for your event description.', GRVE_THEME_TRANSLATE ),
						'options' => $grve_color_selection,
						'default' => 'light',
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Event Bar', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set your color preferences for the Event Bar.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
				...
				'fields' => array(
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Background color for your Event Bar.', GRVE_THEME_TRANSLATE ),
						'default'  => '#252525',
						'transparent' => false,
					),
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Font Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Font color for your Event Bar.', GRVE_THEME_TRANSLATE ),
						'default'  => '#B2B2B2',
						'transparent' => false,
					),
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Hover Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Hover color for your Event Bar.', GRVE_THEME_TRANSLATE ),
						'default'  => '#ffffff',
						'transparent' => false,
					),
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Background Hover Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Background hover color for your Event Bar.', GRVE_THEME_TRANSLATE ),
						'default'  => '#ff6863',
						'transparent' => false,
					),
					array(
						...
						'type'     => 'color',
						'title'    => __( 'Border Color', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Border color for your Event Bar.', GRVE_THEME_TRANSLATE ),
						'default'  => '#303030',
						'transparent' => false,
					),
				)
			...
			$this->sections[] = array(
				'title' => __( 'Colors - Forum Title', GRVE_THEME_TRANSLATE ),
				'header' => '',
				'desc' => __( 'Set the background color for the forum title.', GRVE_THEME_TRANSLATE ),
				'icon_class' => 'el-icon-large',
				'icon' => 'el-icon-brush',
				'submenu' => false,
				'panel' => false,
			...
			$this->sections[] = array(
				'icon' => 'el-icon-cog',
				'icon_class' => 'el-icon-large',
				'title' => __( 'Miscellaneous', GRVE_THEME_TRANSLATE ),
				'submenu' => true,
				'customizer' => false,
				'fields' => array(
					array(
						'id'=>'wp_gallery_popup',
						'type' => 'switch',
						'title' => __( 'Lightbox for WordPress Gallery', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Toggle lightbox for native WordPress Gallery on or off.', GRVE_THEME_TRANSLATE ),
						"default" => '0',
						'on' => __('On', GRVE_THEME_TRANSLATE ),
						'off' => __('Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						...
						'type' => 'switch',
						'title' => __( 'Logo as text', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Toggle logo as text on or off. When on, all logo images will be replaced with site name.', GRVE_THEME_TRANSLATE ),
						"default" => '0',
						'on' => __('On', GRVE_THEME_TRANSLATE ),
						'off' => __('Off', GRVE_THEME_TRANSLATE ),
					),
					array(
						'id' => 'logo_header_tag',
						'type' => 'checkbox',
						'title' => __( 'Logo h1 tag', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want to wrap your logo in h1 tag.', GRVE_THEME_TRANSLATE ),
						'default' => 1,
					),
					array(
						'id' => 'settings_mode',
						'type' => 'select',
						'title' => __( 'In page settings mode ( Extra Settings )', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the mode for the in page extra settings, compact with modal window or simple.', GRVE_THEME_TRANSLATE ),
					...
					array(
						'id' => 'retina_support',
						'type' => 'select',
						'title' => __( 'Retina Support', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the retina suppport of your site.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type' => 'select',
						'title' => __( 'Main Menu Integration', GRVE_THEME_TRANSLATE ),
						'subtitle' => __( 'Select the main menu integration method. Selection available for custom menu integration.', GRVE_THEME_TRANSLATE ),
					...
					array(
						...
						'type' => 'checkbox',
						'title' => __( 'Disable WordPress SEO Page Analysis', GRVE_THEME_TRANSLATE ),
						'subtitle'=> __( 'Select if you want to disable WordPress SEO page analysis.', GRVE_THEME_TRANSLATE ),
						'default' => 0,
					),
				)
			);
			...
			if ( ( defined( 'GRVE_REDUX_CUSTOM_PANEL' ) &&  true === GRVE_REDUX_CUSTOM_PANEL ) || $this->grve_redux_customizer_visibility() ) {
