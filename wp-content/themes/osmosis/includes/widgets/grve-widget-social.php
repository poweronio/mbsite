...
class GRVE_Widget_Social extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$grve_social_items = array (
			...
			array(
				'title' => 'SoundCloud',
				'url' => grve_array_value( $instance, 'soundcloud_url' ),
				'class' => 'soundcloud',
			),
			array(
				'title' => 'WeChat',
			...
			array(
				'title' => 'XING',
				'url' => grve_array_value( $instance, 'xing_url' ),
				'class' => 'xing',
			),
			array(
				'title' => 'VK',
				'url' => grve_array_value( $instance, 'vk_url' ),
				'class' => 'vk',
			),
			array(
				'title' => 'VSCO',
				'url' => grve_array_value( $instance, 'vsco_url' ),
				'class' => 'vsco',
			),
		);
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['vsco_url'] = strip_tags( $new_instance['vsco_url'] );
