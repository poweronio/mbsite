	...
	<?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>
		...
		<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
			...
			<li id="<?php bp_group_invite_item_id(); ?>">
				...
				<h5 class="mg-bottom-10"><?php bp_group_invite_user_link(); ?></h5>
				<div class="mg-bottom-10">
					<em>
						<span class="activity small fg-asbestos">
				...
				<div class="action">
					<a class="button remove btn btn-danger" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'klein' ); ?></a>
...
<div class="submit">
	<input type="submit" name="submit" id="submit" value="<?php esc_attr_e( 'Send Invites', 'klein' ); ?>" />
</div>
