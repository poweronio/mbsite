...
<div id="message" class="info">
	...
	<?php if ( bp_is_my_profile() ) : ?>
		...
		<p><?php _e( 'Deleting your account will delete all of the content you have created. It will be completely irrecoverable.', 'klein' ); ?></p>

	<?php else : ?>

		<p><?php _e( 'Deleting this account will delete all of the content it has created. It will be completely irrecoverable.', 'klein' ); ?></p>
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	...
	<label>
		<input type="checkbox" name="delete-account-understand" id="delete-account-understand" value="1" onclick="if(this.checked) { document.getElementById('delete-account-button').disabled = ''; } else { document.getElementById('delete-account-button').disabled = 'disabled'; }" />
		 <?php _e( 'I understand the consequences.', 'klein' ); ?>
	</label>

	<p class="separator"></p>

	<div class="submit mg-top-20">
		<input class="btn btn-danger" type="submit" disabled="disabled" value="<?php esc_attr_e( 'Delete Account', 'klein' ); ?>" id="delete-account-button" name="delete-account-button" />
	</div>
