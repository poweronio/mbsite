...
<div id="page" class="hfeed site <?php echo $container_class; ?>">
	...
	<div id="klein-top-links" class="header-style-6">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<div class="">
							<?php
								...
								if (empty($toplinks)) {
									...
									<ul class="top-links-menu-container no-list">
										<li>
											<a title="<?php _e('Select Top Links Menu', 'klein');?>" href="<?php echo admin_url(); ?>/nav-menus.php?action=locations">
												<?php _e('Select Top Links Menu', 'klein');?>
											</a>
										</li>
									</ul>
									<?php
